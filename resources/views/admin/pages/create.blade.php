...
@section('title', 'New Page — Debesties Studio')
...
<div style="background: var(--cms-surface); border: 1px solid var(--cms-border); border-radius: var(--cms-r-xl); padding: 28px; box-shadow: var(--cms-sh-card); max-width: 800px; margin: 0 auto;">
    ...
    <form action="{{ route('admin.pages.store') }}" method="POST" style="display: flex; flex-direction: column; gap: 20px;">
        @csrf
        ...
        <div>
            ...
            <input type="text" name="title" value="{{ old('title') }}" placeholder="e.g. About Us" required
