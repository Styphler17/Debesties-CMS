...
<div style="max-width: 800px; margin: 0 auto; display: flex; flex-direction: column; gap: 20px;">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between;">
        <a href="{{ route('admin.newsletters.show', $newsletter) }}" style="display: inline-flex; align-items: center; gap: 6px; font-family: var(--cms-font-ui), sans-serif; font-size: 13.5px; color: var(--cms-fg3); text-decoration: none;">
