    ...
    <div class="settings-group" style="background: var(--cms-surface); border: 1px solid var(--cms-border); border-radius: var(--cms-r-lg); overflow: hidden; box-shadow: var(--cms-sh-card);">
        <header onclick="toggleAccordion('general')" style="padding: 20px 24px; display: flex; align-items: center; justify-content: space-between; cursor: pointer; transition: background 150ms;" onmouseover="this.style.background='#FDFBF9'" onmouseout="this.style.background='transparent'">
            <div style="display: flex; align-items: center; gap: 14px;">
                ...
                <div>
                    <h3 style="font-family: var(--cms-font-ui); font-size: 15px; font-weight: 700; color: var(--cms-fg1);">General Settings</h3>
                    <p style="font-family: var(--cms-font-ui); font-size: 12.5px; color: var(--cms-fg3); margin-top: 1px;">Configure site title, email, timezone, and formatting settings.</p>
                </div>
            </div>
    ...
    <div class="settings-group" style="background: var(--cms-surface); border: 1px solid var(--cms-border); border-radius: var(--cms-r-lg); overflow: hidden; box-shadow: var(--cms-sh-card);">
        <header onclick="toggleAccordion('seo')" style="padding: 20px 24px; display: flex; align-items: center; justify-content: space-between; cursor: pointer; transition: background 150ms;" onmouseover="this.style.background='#FDFBF9'" onmouseout="this.style.background='transparent'">
            <div style="display: flex; align-items: center; gap: 14px;">
                ...
                <div>
                    <h3 style="font-family: var(--cms-font-ui); font-size: 15px; font-weight: 700; color: var(--cms-fg1);">SEO Defaults</h3>
                    <p style="font-family: var(--cms-font-ui); font-size: 12.5px; color: var(--cms-fg3); margin-top: 1px;">Manage default meta templates, Open Graph structures, and indexing rules.</p>
                </div>
            </div>
        ...
        <div class="accordion-content" id="content-seo" style="border-top: 1px solid var(--cms-border); padding: 24px; display: none;">
            <form onsubmit="saveSection(event, 'SEO Defaults')">
                <div style="display: flex; flex-direction: column; gap: 20px; margin-bottom: 20px;">
                    ...
                    <div>
                        <label style="font-family: var(--cms-font-ui); font-size: 12px; font-weight: 700; color: var(--cms-fg3); text-transform: uppercase; letter-spacing: 0.04em; display: block; margin-bottom: 6px;">Default Open Graph (OG) Image</label>
                        <div style="display: flex; gap: 16px; align-items: center;">
                            ...
                            <div>
                                ...
                                <button type="button" onclick="document.getElementById('og-file-input').click()"
                                        style="font-family: var(--cms-font-ui); font-size: 13px; font-weight: 600; background: var(--cms-surface); border: 1.5px solid var(--cms-border); padding: 8px 14px; border-radius: var(--cms-r-md); color: var(--cms-fg1); cursor: pointer; transition: all 120ms;"
    ...
    <div class="settings-group" style="background: var(--cms-surface); border: 1px solid var(--cms-border); border-radius: var(--cms-r-lg); overflow: hidden; box-shadow: var(--cms-sh-card);">
        <header onclick="toggleAccordion('media')" style="padding: 20px 24px; display: flex; align-items: center; justify-content: space-between; cursor: pointer; transition: background 150ms;" onmouseover="this.style.background='#FDFBF9'" onmouseout="this.style.background='transparent'">
            <div style="display: flex; align-items: center; gap: 14px;">
                ...
                <div>
                    <h3 style="font-family: var(--cms-font-ui); font-size: 15px; font-weight: 700; color: var(--cms-fg1);">Media & Uploads</h3>
                    <p style="font-family: var(--cms-font-ui); font-size: 12.5px; color: var(--cms-fg3); margin-top: 1px;">Adjust maximum upload parameters, compressions, and accepted file extensions.</p>
                </div>
            </div>
