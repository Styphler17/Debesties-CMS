...
<div style="background: var(--cms-surface); border: 1px solid var(--cms-border); border-radius: var(--cms-r-xl); padding: 28px; max-width: 600px; box-shadow: var(--cms-sh-card);">
    <form method="POST" action="{{ route('admin.users.store') }}" enctype="multipart/form-data">
        ...
        <div style="display: flex; flex-direction: column; gap: 20px;">
            ...
            <div>
                <label style="font-family: var(--cms-font-ui); font-size: 12px; font-weight: 700; color: var(--cms-fg3); text-transform: uppercase; display: block; margin-bottom: 6px;">Password</label>
            ...
            <div>
                ...
                <textarea name="bio" style="width: 100%; height: 80px; padding: 10px 12px; font-family: var(--cms-font-ui); font-size: 13.5px; color: var(--cms-fg1); background: var(--cms-bg); border: 1.5px solid var(--cms-border); border-radius: var(--cms-r-md); outline: none; resize: none;">{{ old('bio') }}</textarea>
