    ...
    <div style="display: flex; align-items: center; justify-content: space-between; gap: 14px; flex-wrap: wrap;">
        ...
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <button onclick="openAddTag()"
                    style="display: inline-flex; align-items: center; gap: 7px; font-family: var(--cms-font-ui); font-size: 13.5px; font-weight: 600; padding: 0 18px; height: 38px; background: var(--cms-gold); color: #1A1410; border: none; border-radius: var(--cms-r-md); cursor: pointer; white-space: nowrap;"
    ...
    <div style="display: grid; grid-template-columns: 1fr 320px; gap: 20px; align-items: start;">
        ...
        <div style="display: flex; flex-direction: column; gap: 16px;">
            ...
            <div style="background: var(--cms-surface); border: 1px solid var(--cms-border); border-radius: var(--cms-r-lg); overflow: hidden; box-shadow: var(--cms-sh-card);">
                <div style="display: flex; align-items: center; justify-content: space-between; padding: 14px 20px; border-bottom: 1px solid var(--cms-border);">
                    <span style="font-family: var(--cms-font-ui); font-size: 14px; font-weight: 700; color: var(--cms-fg1);">All Tags</span>
                    <div id="bulk-bar" style="display: none; align-items: center; gap: 8px;">
                        ...
                        <button onclick="bulkDelete()" style="height: 32px; padding: 0 14px; font-family: var(--cms-font-ui); font-size: 12.5px; font-weight: 600; background: var(--cms-red-soft); color: var(--cms-red-deep); border: 1.5px solid rgba(200,55,43,0.2); border-radius: var(--cms-r-md); cursor: pointer;">Delete Selected</button>
                    </div>
                </div>
                <table style="width: 100%; border-collapse: collapse; font-family: var(--cms-font-ui);" id="tags-table">
                    <thead>
        ...
        <div style="background: var(--cms-surface); border: 1px solid var(--cms-border); border-radius: var(--cms-r-lg); overflow: hidden; box-shadow: var(--cms-sh-card); position: sticky; top: 88px;">
                ...
                <div>
                    ...
                    <div style="display: flex; align-items: center; gap: 6px; height: 40px; background: var(--cms-bg); border: 1.5px solid var(--cms-border); border-radius: var(--cms-r-md); padding: 0 12px;">
                        <input id="new-tag-slug" type="text" placeholder="auto-generated"
                               style="border: none; outline: none; background: none; flex: 1; font-family: var(--cms-font-mono); font-size: 12.5px; color: var(--cms-fg2);" />
                    </div>
                </div>
                <div style="display: flex; gap: 8px; padding-top: 4px;">
                    <button type="button" id="cancel-btn" onclick="resetForm()" style="display: none; flex: 1; height: 38px; font-family: var(--cms-font-ui); font-size: 13.5px; font-weight: 600; background: var(--cms-bg); color: var(--cms-fg2); border: 1.5px solid var(--cms-border); border-radius: var(--cms-r-md); cursor: pointer;">Cancel</button>
                    <button type="submit" id="submit-btn"
                            style="flex: 1; height: 38px; font-family: var(--cms-font-ui); font-size: 13.5px; font-weight: 700; background: var(--cms-gold); color: #1A1410; border: none; border-radius: var(--cms-r-md); cursor: pointer;"
                            onmouseover="this.style.background='#D69B00'" onmouseout="this.style.background='var(--cms-gold)'">
                        Add Tag
                    </button>
                </div>
            ...
            <div style="padding: 0 18px 16px; border-top: 1px solid var(--cms-border); padding-top: 14px;">
                <div style="font-family: var(--cms-font-ui); font-size: 12px; color: var(--cms-fg4); line-height: 1.5;">
...
<div id="delete-modal" style="display: none; position: fixed; inset: 0; background: rgba(20,16,12,0.5); z-index: 200; align-items: center; justify-content: center; animation: dsFade 180ms ease;">
    <div style="background: var(--cms-surface); border-radius: var(--cms-r-xl); padding: 28px; width: 360px; max-width: calc(100vw - 40px); box-shadow: var(--cms-sh-pop); animation: dsPop 200ms ease;">
        <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 14px;">
            ...
            <div>
                <div style="font-family: var(--cms-font-ui); font-size: 15px; font-weight: 700; color: var(--cms-fg1);">Delete Tag?</div>
