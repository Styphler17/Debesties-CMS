...
@if(session('success'))
    <div style="background: var(--cms-green-soft); color: var(--cms-green-deep); padding: 12px 18px; border-radius: var(--cms-r-md); border: 1px solid rgba(26,138,75,0.2); margin-bottom: 16px; font-family: var(--cms-font-ui), sans-serif; font-size: 14px; font-weight: 600;">
        {{ session('success') }}
    </div>
@endif
@if(session('error'))
    <div style="background: var(--cms-red-soft); color: var(--cms-red-deep); padding: 12px 18px; border-radius: var(--cms-r-md); border: 1px solid rgba(200,55,43,0.2); margin-bottom: 16px; font-family: var(--cms-font-ui), sans-serif; font-size: 14px; font-weight: 600;">
        {{ session('error') }}
    </div>
@endif
...
<div style="display: grid; grid-template-columns: 320px 1fr; gap: 24px; align-items: start;">
    ...
    <div style="display: flex; flex-direction: column; gap: 16px;">
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <div style="font-family: var(--cms-font-ui), sans-serif; font-size: 13px; font-weight: 700; color: var(--cms-fg3); text-transform: uppercase; letter-spacing: 0.04em;">System Roles</div>
            <button onclick="openAddRoleModal()"
                    style="display: inline-flex; align-items: center; gap: 5px; height: 32px; padding: 0 12px; font-family: var(--cms-font-ui), sans-serif; font-size: 12.5px; font-weight: 600; background: var(--cms-gold); color: #1A1410; border: none; border-radius: var(--cms-r-md); cursor: pointer; transition: background 150ms;"
        ...
        <div id="role-cards-container" style="display: flex; flex-direction: column; gap: 10px;">
            @foreach($roles as $role)
                @php
                    ...
                    $borderStyle = "border: 1.5px solid " . ($loop->first ? 'var(--cms-gold)' : 'var(--cms-border)') . ";";
                    $cardStyle = "background: var(--cms-surface); border-radius: var(--cms-r-lg); padding: 16px; cursor: pointer; transition: all 150ms; position: relative; $borderStyle";
                @endphp
                <div class="role-card" 
                    ...
                    <div style="font-family: var(--cms-font-ui), sans-serif; font-size: 14.5px; font-weight: 700; color: var(--cms-fg1); margin-bottom: 4px;" class="role-card-name">
                        {{ $role->name }}
                    </div>
                    
                    <div style="font-family: var(--cms-font-ui), sans-serif; font-size: 12.5px; color: var(--cms-fg3); line-height: 1.4; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; margin-bottom: 12px;" class="role-card-desc">
    ...
    <div style="background: var(--cms-surface); border: 1px solid var(--cms-border); border-radius: var(--cms-r-xl); padding: 28px; box-shadow: var(--cms-sh-card);">
            ...
            <div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 16px;">
                <div style="flex: 1;">
                    <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 6px;">
                        <h2 id="active-role-name" style="font-family: var(--cms-font-disp), serif; font-size: 24px; font-weight: 700; color: var(--cms-fg1); cursor: pointer; border-bottom: 1px dashed var(--cms-border-st); padding-bottom: 2px;" onclick="startEditRoleName()" title="Click to edit role name">
                            Super Admin
                        </h2>
                        <input id="active-role-name-input" type="text" style="display: none; font-family: var(--cms-font-disp), serif; font-size: 24px; font-weight: 700; color: var(--cms-fg1); background: var(--cms-bg); border: 1.5px solid var(--cms-gold); border-radius: var(--cms-r-md); padding: 2px 8px; outline: none; width: 300px;" onblur="finishEditRoleName()" onkeydown="if(event.key === 'Enter') finishEditRoleName()" />
                    ...
                    <div id="active-role-desc" style="font-family: var(--cms-font-ui), sans-serif; font-size: 13.5px; color: var(--cms-fg3); line-height: 1.5; cursor: pointer;" onclick="startEditRoleDesc()" title="Click to edit description">
                        Full access to all system features.
                    </div>
                    <textarea id="active-role-desc-input" style="display: none; font-family: var(--cms-font-ui), sans-serif; font-size: 13.5px; color: var(--cms-fg1); background: var(--cms-bg); border: 1.5px solid var(--cms-gold); border-radius: var(--cms-r-md); padding: 6px 10px; outline: none; width: 100%; height: 60px; resize: none; margin-top: 4px;" onblur="finishEditRoleDesc()" onkeydown="if(event.key === 'Enter') { event.preventDefault(); finishEditRoleDesc(); }"></textarea>
                </div>
                ...
                <div id="admin-fixed-badge" style="display: flex; align-items: center; gap: 6px; padding: 6px 12px; border-radius: var(--cms-r-md); background: var(--cms-gold-soft); border: 1px solid rgba(232,168,0,0.25);">
                    ...
                    <span style="font-family: var(--cms-font-ui), sans-serif; font-size: 12px; font-weight: 700; color: var(--cms-gold-deep);">Permissions Locked</span>
                </div>
            </div>
        </div>
        ...
        {{-- Permission Grid --}}
        <div>
            <div style="font-family: var(--cms-font-ui), sans-serif; font-size: 13px; font-weight: 700; color: var(--cms-fg2); text-transform: uppercase; letter-spacing: 0.04em; margin-bottom: 14px;">Capabilities Matrix</div>
                ...
                <table style="width: 100%; border-collapse: collapse; background: var(--cms-surface);">
                    <thead>
                        <tr style="background: var(--cms-bg); border-bottom: 1px solid var(--cms-border);">
                            <th style="padding: 14px 20px; text-align: left; font-family: var(--cms-font-ui), sans-serif; font-size: 12px; font-weight: 700; color: var(--cms-fg3); text-transform: uppercase; letter-spacing: 0.04em;">Permission Name</th>
                            <th style="padding: 14px 20px; text-align: center; font-family: var(--cms-font-ui), sans-serif; font-size: 12px; font-weight: 700; color: var(--cms-fg3); text-transform: uppercase; letter-spacing: 0.04em; width: 120px;">Allowed</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($permissions as $permission)
                            <tr style="border-bottom: 1px solid var(--cms-border);" class="permission-row" data-id="{{ $permission->id }}">
                                <td style="padding: 16px 20px;">
                                    <div style="font-family: var(--cms-font-ui), sans-serif; font-size: 14px; font-weight: 600; color: var(--cms-fg1);">{{ $permission->name }}</div>
                                    <div style="font-family: var(--cms-font-ui), sans-serif; font-size: 12px; color: var(--cms-fg4); margin-top: 1px;">Grant access to the <code>{{ $permission->slug }}</code> capability.</div>
                                </td>
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; margin-top: 24px;">
            <div id="status-hint-text" style="font-family: var(--cms-font-ui), sans-serif; font-size: 13px; color: var(--cms-fg3);">
    ...
    <div style="background: var(--cms-surface); border-radius: var(--cms-r-xl); padding: 28px; width: 440px; max-width: calc(100vw - 40px); box-shadow: var(--cms-sh-pop); animation: dsPop 200ms ease;">
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px;">
            <div style="display: flex; align-items: center; gap: 10px;">
                ...
                <span style="font-family: var(--cms-font-ui), sans-serif; font-size: 16px; font-weight: 700; color: var(--cms-fg1);">Create Custom Role</span>
            </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 14px;">
            <div>
                <label style="font-family: var(--cms-font-ui), sans-serif; font-size: 12px; font-weight: 700; color: var(--cms-fg3); text-transform: uppercase; letter-spacing: 0.04em; display: block; margin-bottom: 6px;">Role Name</label>
            ...
            <div>
                ...
                <textarea id="new-role-desc" placeholder="What is this role allowed to do?"
                          style="display: block; width: 100%; height: 80px; padding: 10px 12px; font-family: var(--cms-font-ui), sans-serif; font-size: 13.5px; color: var(--cms-fg1); background: var(--cms-bg); border: 1.5px solid var(--cms-border); border-radius: var(--cms-r-md); outline: none; resize: none;"
                          onfocus="this.style.borderColor='var(--cms-gold)'; this.style.boxShadow='0 0 0 3px rgba(232,168,0,0.13)'"
                          onblur="this.style.borderColor='var(--cms-border)'; this.style.boxShadow='none'"></textarea>
            </div>
        </div>
        <div style="display: flex; gap: 8px; margin-top: 20px;">
            <button onclick="closeAddRoleModal()" style="flex: 1; height: 40px; font-family: var(--cms-font-ui), sans-serif; font-size: 13.5px; font-weight: 600; background: var(--cms-bg); color: var(--cms-fg2); border: 1.5px solid var(--cms-border); border-radius: var(--cms-r-md); cursor: pointer;">Cancel</button>
            <button onclick="submitAddRole()" style="flex: 2; height: 40px; font-family: var(--cms-font-ui), sans-serif; font-size: 13.5px; font-weight: 700; background: var(--cms-gold); color: #1A1410; border: none; border-radius: var(--cms-r-md); cursor: pointer; transition: background 150ms;"
                    onmouseover="this.style.background='#D69B00'" onmouseout="this.style.background='var(--cms-gold)'">
                Create Role
            </button>
        </div>
...
<div id="delete-role-modal" style="display: none; position: fixed; inset: 0; background: rgba(20,16,12,0.5); z-index: 200; align-items: center; justify-content: center;">
    <div style="background: var(--cms-surface); border-radius: var(--cms-r-xl); padding: 28px; width: 380px; max-width: calc(100vw - 40px); box-shadow: var(--cms-sh-pop); animation: dsPop 200ms ease;">
        <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 10px;">
            ...
            <div>
                <div style="font-family: var(--cms-font-ui), sans-serif; font-size: 15px; font-weight: 700; color: var(--cms-fg1);">Delete Role?</div>
                <div id="delete-role-label" style="font-family: var(--cms-font-ui), sans-serif; font-size: 13px; color: var(--cms-fg3); margin-top: 2px;"></div>
            </div>
        </div>
        <div style="background: var(--cms-red-soft); border: 1px solid rgba(200,55,43,0.2); border-radius: var(--cms-r-md); padding: 10px 14px; margin: 12px 0; font-family: var(--cms-font-ui), sans-serif; font-size: 12.5px; color: var(--cms-red-deep);">
            All users currently assigned to this role will need to be reassigned.
        </div>
        <div style="display: flex; gap: 8px; justify-content: flex-end;">
            <button onclick="closeDeleteRole()" style="height: 38px; padding: 0 18px; font-family: var(--cms-font-ui), sans-serif; font-size: 13.5px; font-weight: 600; background: var(--cms-surface); color: var(--cms-fg2); border: 1.5px solid var(--cms-border); border-radius: var(--cms-r-md); cursor: pointer;">Cancel</button>
            <button onclick="submitDeleteRole()" style="height: 38px; padding: 0 18px; font-family: var(--cms-font-ui), sans-serif; font-size: 13.5px; font-weight: 600; background: var(--cms-red); color: #fff; border: none; border-radius: var(--cms-r-md); cursor: pointer;">Delete Role</button>
        </div>
    </div>
</div>
