...
@section('title', 'Tag: #' . $tag->name . ' - ' . \App\Services\SettingsService::get('site_name', 'Debesties CMS'))
...
@section('content')
    ...
    <div class="tag-header">
        <span class="kicker">Archive Tag</span>
    ...
    @else
        <div style="text-align: center; padding: 4rem 1.5rem; border: 1px dashed var(--border-color); border-radius: var(--radius-lg); background-color: var(--card-bg);">
            <p style="color: var(--text-muted); font-size: 1.1rem;">No articles found with this tag yet.</p>
        </div>
    @endif
